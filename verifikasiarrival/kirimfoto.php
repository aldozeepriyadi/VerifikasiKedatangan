...
<head>
    ...
    <title>Kirim Foto Ke Customer</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    ...
                    ?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Kirim Foto Ke Customer</h1>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <button type="button" class="btn btn-primary"
                                                        onclick="startWebcam()">Open Webcam</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="border-top">
                                                <div class="card-body">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        onclick="updateDatabase()">Update Image</button>
    ...
    <script>
        ...
        function updateDatabase() {
            ...
            const userId = 1; // Replace with your actual user ID or identifier
                ...
                if (xhr.status === 200) {
                    try {
                        ...
                        if (response.status === 'success') {
                            console.log('Image uploaded successfully. Image URL:', response.image_url);
                        } else {
            ...
            // Modify the data sent in the request
            xhr.send(`userId=${userId}&imageCanvas=${encodeURIComponent(imageBase64)}`);
        }
    </script>
