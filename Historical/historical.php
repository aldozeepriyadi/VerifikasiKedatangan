...
// For Current Event
$sqlProblem = "SELECT id_schedule,lat,longi,problem,bukti_foto,inst_usr FROM problem_delivery WHERE inst_usr='" . $_SESSION['id_driver'] . "'";
...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="tables-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="historical.php" class="active">
                            <i class="bi bi-circle"></i><span>Historical Problem</span>
                        </a>

                    </li>
                    <li>
                        <a href="historicalKedatangan.php">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Historical Problem</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active">Historical Problem</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Historical Problem</h5>
                                        ...
                                        while ($rowProblem = mysqli_fetch_assoc($resultProblem)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $sql2 = "SELECT nama
                                                         FROM driver where id_driver = '" . $rowProblem["inst_usr"] . "'";
